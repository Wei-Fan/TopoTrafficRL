...
from ttrl_env.utils import Vector
from ttrl_env.vehicle.controller import MDPVehicle
from ttrl_env.vehicle.dynamics import BicycleVehicle
...
class ActionType:
    ...
    def vehicle_class(self) -> Callable:
        ...
        Must return a subclass of :py:class:`ttrl_env.vehicle.kinematics.Vehicle`.
        """
        raise NotImplementedError
    ...
    def act(self, action: Action) -> None:
        ...
        vehicle is an instance of the specified :py:class:`ttrl_env.envs.common.action.ActionType.vehicle_class`.
