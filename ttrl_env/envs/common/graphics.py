...
from ttrl_env.envs.common.action import (
    ActionType,
    ContinuousAction,
    DiscreteMetaAction,
)
from ttrl_env.road.graphics import RoadGraphics, WorldSurface
from ttrl_env.vehicle.graphics import VehicleGraphics


if TYPE_CHECKING:
    from ttrl_env.envs import AbstractEnv
    from ttrl_env.envs.common.abstract import Action
...
class ObservationGraphics:
    ...
    def display(cls, obs, sim_surface):
        from ttrl_env.envs.common.observation import LidarObservation
