...
from ttrl_env.envs.common.action import Action, ActionType, action_factory
from ttrl_env.envs.common.finite_mdp import finite_mdp
from ttrl_env.envs.common.graphics import EnvViewer
from ttrl_env.envs.common.observation import ObservationType, observation_factory
from ttrl_env.vehicle.behavior import IDMVehicle
...
class AbstractEnv(gym.Env):
    ...
    def default_config(cls) -> dict:
        ...
        return {
            ...
            "other_vehicles_type": "ttrl_env.vehicle.behavior.IDMVehicle",
            "screen_width": 600,  # [px]
    ...
    def change_vehicles(self, vehicle_class_path: str) -> AbstractEnv:
        ...
        :param vehicle_class_path: The path of the class of behavior for other vehicles
                             Example: "ttrl_env.vehicle.behavior.IDMVehicle"
